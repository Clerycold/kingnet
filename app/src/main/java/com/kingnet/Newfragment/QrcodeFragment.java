...
public class QrcodeFragment extends BaseFragment {
    ...
    public static QrcodeFragment newInstance(String title, int indicatorColor, int dividerColor) {
    ...
    private void xmlArrange(){
        ...
        RelativeLayout.LayoutParams barcode_img_lay=new RelativeLayout.LayoutParams((int) (double) ((Width/6.3)*3.3),(int) (double) ((Width/6.3)*3.3));
