...
public class MessagecommunityFrag extends MessageBaseFragment{
    View rootView;
    ...
    public static MessagecommunityFrag newInstance(String title, int indicatorColor, int dividerColor) {
        MessagecommunityFrag f = new MessagecommunityFrag();
        f.setTitle(title);
